...
class BoardController: NSObject,
  ...
  func enter(_ string: String) {
    ...
    UIView.animate(withDuration: 0.1,
      ...
      // ...
        cell.transform = cell.transform.scaledBy(x: 1.05, y: 1.05) // Slightly enlarge the cell
      // END YOUR CODE HERE
  ...
  func deleteLastCharacter() {
    ...
    // ...
      ...
      cell.clearLetter() // Clears the letter in the cell
      cell.set(style: .initial) // Resets the style to the default state
    // END YOUR CODE HERE
  }
}
